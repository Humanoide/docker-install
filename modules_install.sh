...
git clone -b 15.0 https://github.com/OCA/commission.git 
...
git clone -b 15.0 https://github.com/OCA/l10n-spain.git 
...
git clone -b 15.0 https://github.com/OCA/social 
...
git clone -b 15.0 https://github.com/OCA/website.git 
git clone -b 15.0 https://github.com/CybroOdoo/CybroAddons.git 
